...
layout: article
title: 2.GoogLeNet
cover: /assets/images/Blog/2.GoogLeNet/cover.jpg
...
article_header:
  type: cover
  image:
    src: /assets/images/Blog/2.GoogLeNet/header.png
...
GoogLeNet是2014年ILSVRC图像分类和定位两个任务的挑战赛冠军，用一个22层的深度网络将图像分类Top-5的错误率降低到6.67%。为了直径卷积网络的经典结构LeNet-5，同时兼顾Google的品牌，Google团队为竞赛模型起了GoogLeNet的名字
<!--more-->
...
![alt](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1__X6NzAnveK3QBT029X8D7Q.png)

# GoogLeNet [Inception-v1] 结构
...
![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/141544_FfKB_876354-1618449120996.jpg)
...
![GoogLeNet3.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498226595-023d7a07-cca9-4ab9-8af2-debd2b8b7926.png)
...
![image-20210415224830771](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/image-20210415224830771.png)

注：上表中的“#3x3 reduce”，“#5x5 reduce”表示在3x3，5x5卷积操作之前使用了1x1卷积的数量

从GoogLeNet的实验结果来看，效果很明显，差错率比MSRA、VGG等模型都要低，对比结果如下表所示：

![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/141641_H28K_876354.png)



## 分层解析

<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/image-20210415225729004.png" alt="image-20210415225729004" style="zoom:67%;" />
...
![image-20210415193105777](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/image-20210415193105777.png)
...
<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498289290-f37fcc5d-2d62-4ceb-b949-4ab99550caf0.png" alt="GoogLeNet5.png" style="zoom:67%;" />
...
![image-20210415193434972](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/image-20210415193434972.png)
...
![image-20210415194250729](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/image-20210415194250729.png)
...
在GoogLeNet中，基本的卷积块被称为*Inception模块*（Inception block）。这很可能得名于电影《盗梦空间》（Inception），因为电影中的一句话：“We need to go deeper”

![img](https://miro.medium.com/max/500/0*9oltTOaaHAbeLzeh.jpg)

inception模块结构

![../_images/inception.svg](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/inception.svg)
...
## Inception灵感：Network in Network (NIN)



 **NIN：卷积层+用1X1层替代全连接层+全局平均池化**

AlexNet、VGG（左边）与NIN结构（右边）的区别：

<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-4f0f67185cdc4e241113a1c1f2bec885_b.jpg" alt="img" style="zoom:67%;" />
...
![GoogLeNet4.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498270835-b7379ad3-0375-4df9-9d9c-eb3992f45fdb.png)
...
![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-fa6813ae7f80db92580404ef652800e6_1440w.jpg)
...
<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-94f1414b18179cbb326eb77b1d3018f6_1440w.jpg" alt="img" style="zoom:67%;" />
...
![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1496926-8a2f31f55ed4ebaa.png)
...
<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-a5cf78a217e1c90e0d3ced060296659c_1440w.jpg" alt="img" style="zoom:67%;" />
...
<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-495ba8088403c1d4374cdf77dbb104a6_1440w.jpg" alt="img" style="zoom:50%;" />
...
<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-66344258d8888ab1fb697934b07a0914_1440w.jpg" alt="img" style="zoom:50%;" />
...
<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-bb195740c563873ae100ad12dcb6a434_1440w.jpg" alt="img" style="zoom:50%;" />
...
![GoogLeNet7.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498319119-7ea79d12-507b-49ed-bd17-6a1e52128c69.png)

<img src="assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498270835-b7379ad3-0375-4df9-9d9c-eb3992f45fdb.png" alt="GoogLeNet4.png" style="zoom:67%;" />
...
![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-d047d9d4b1a67cfb91501c71c1eb7315_1440w.jpg)
...
![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/v2-eacad5957624f2b0dec823af256817cf_1440w.jpg)
...
![GoogLeNet6.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498304355-78f7eb99-7a8d-4a4c-a949-739913910de5.png)
...
![GoogLeNet8.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498368622-353d2699-11b3-40fe-9efd-1671ce7462ff.png)
...
![GoogLeNet9.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498397428-af45d028-67aa-4928-8ddc-98d40c13311d.png)
...
![GoogLeNet10.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498412511-f9752c4c-335a-4d8f-9ce5-e1dd8b96fd3b.png)
...
在v2的基础上进一步分解大的卷积，比如把![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/cf1193335575230a1a03e9457c55b6f7.svg)的卷积拆分成两个一维的卷积：![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/4a03f8cad1f86f0b01958c67ed8d1105.svg)，![img](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/cf205bf19d67d9f03972f2ae9ff39649.svg)。例如7*7的卷积可以被拆分为1*7和7*1两个卷积。此外，采用了一些巧妙的方法进一步优化了部分卷积层的设计。



![GoogLeNet11.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498431380-1b8c7dee-638f-45d9-97cc-2a50ac374d63.png)

![GoogLeNet12.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498448021-d994a969-8920-40e8-95b7-51d69084556a.png)
...
![GoogLeNet13.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498472642-927cf462-70d2-4f37-869c-1c57b605f21c.png)![GoogLeNet14.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498483598-178e6fd4-3c6e-4fe4-b99b-06e78d25e361.png)

![GoogLeNet15.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498510002-ba375012-3d2c-4596-97d9-3a7a29e5b2ed.png)![GoogLeNet16.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498522094-046ffae9-d685-4b6d-8489-d31220881f3c.png)
...
![GoogLeNet17.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498545347-e9bc901c-f13f-4624-af8a-878de0ebdf4b.png)
...
![GoogLeNet18.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498559596-f63dec8b-0370-453d-a92d-0779cf60d003.png)
...
![GoogLeNet19.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498575752-a196d91b-275d-49ea-af99-9f38cd6e712a.png)



Inception-ResNet引入残差连接，它将Inception模块的卷积运算输出添加到输入上。为了使残差加运算可行，卷积之后的输入和输出必须有相同的维度。因此，我们在初始卷积之后使用1*1卷积来匹配深度（深度在卷积之后会增加）。

![GoogLeNet20.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498592225-ea4b4993-e536-451a-8b9e-c42c181a2834.png)
...
![GoogLeNet21.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498624941-ea54e549-6901-44d8-8e6b-2375d24db2d1.png)
...
![GoogLeNet22.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498640006-fa774994-786a-416b-bb2b-53db3515d7e6.png)
...
![GoogLeNet23.png](assets/images/Blog/2.GoogLeNet/GoogLeNet.assets/1598498654380-7883167e-7c2b-47d7-a6e5-a53fdac51bd4.png)
